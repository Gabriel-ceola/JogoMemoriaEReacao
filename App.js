...
const App = () => {
    ...
    return new Promise((resolve) => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          resolve();
        }, 800); // Mantém o LED aceso por 500ms
      }, 200); // Delay para garantir que apague entre piscadas consecutivas
    });
  };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Jogo da Memória e Reação</Text>
      ...
      <TouchableOpacity style={styles.button} onPress={startMemoryGame}>
        <Text style={styles.buttonText}>Iniciar Jogo de Memória</Text>
      </TouchableOpacity>
    </View>
  );
};
